...
namespace Navicon.Common.Entities
{
	...
	public partial class new_agreement : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public const string EntityLogicalCollectionName = "new_agreements";
		
		public const string EntitySetName = "new_agreements";
		...
		public System.Nullable<Navicon.Common.Entities.new_agreementState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Navicon.Common.Entities.new_agreementState)(System.Enum.ToObject(typeof(Navicon.Common.Entities.new_agreementState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Navicon.Common.Entities.new_invoice> new_new_agreement_new_invoice_dogovorid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Navicon.Common.Entities.new_invoice>("new_new_agreement_new_invoice_dogovorid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("new_new_agreement_new_invoice_dogovorid");
				this.SetRelatedEntities<Navicon.Common.Entities.new_invoice>("new_new_agreement_new_invoice_dogovorid", null, value);
